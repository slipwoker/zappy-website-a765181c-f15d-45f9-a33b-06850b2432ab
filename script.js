  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') && !VALIDATORS.required(value)) {
        ...
        } else if (field.hasAttribute('minlength') && !VALIDATORS.minlength(value, field.getAttribute('minlength'))) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דופליקטים חדר בריחה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a765181c-f15d-45f9-a33b-06850b2432ab',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a765181c-f15d-45f9-a33b-06850b2432ab';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a765181c-f15d-45f9-a33b-06850b2432ab';
